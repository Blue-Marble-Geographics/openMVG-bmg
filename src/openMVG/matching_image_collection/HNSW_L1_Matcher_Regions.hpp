...
#ifndef OPENMVG_MATCHING_HNSW_L1_MATCHER_REGIONS_HPP
#define OPENMVG_MATCHING_HNSW_L1_MATCHER_REGIONS_HPP
...
/// Using precomputed HNSW L1 indices.
/// HNSW graphs are built once per view and reused for all pairs.
/// Matching is parallelized at the pair level with minimal critical sections.
///
class HNSW_L1_Matcher_Regions : public Matcher
{
  public:
  explicit HNSW_L1_Matcher_Regions
  (
    float dist_ratio
  );
...
#endif // OPENMVG_MATCHING_HNSW_L1_MATCHER_REGIONS_HPP